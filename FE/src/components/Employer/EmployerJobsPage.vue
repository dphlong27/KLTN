...
const deleteJob = async (job) => {
  try {
    ...
    notify.apiError(error, 'Không thể xóa tin tuyển dụng.')
  }
}
  ...
  <div class="max-w-7xl mx-auto w-full">
    ...
    <template v-else>
      ...
      <div class="mb-6 rounded-xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
        ...
        <div class="grid grid-cols-1 gap-3 border-b border-slate-200 p-4 dark:border-slate-800 md:grid-cols-[minmax(0,1fr)_180px_160px]">
          <input
              ...
              >
                ...
                <td class="px-6 py-4">
                  <div class="flex justify-end gap-2">
                    ...
                    <button
                      class="flex size-9 items-center justify-center rounded-lg text-slate-400 transition-colors hover:bg-red-500/10 hover:text-red-400"
                      title="Xóa tin"
                      type="button"
