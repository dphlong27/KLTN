                ...
                <div class="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                  <div class="min-w-0 flex-1">
                    ...
                    <p class="mt-2 text-sm text-slate-600 dark:text-slate-300">
                      Nộp lúc {{ formatDateTime(application.thoi_gian_ung_tuyen) }}
                    </p>
                  </div>
                  <span
                    class="inline-flex items-center rounded-full px-3 py-1 text-xs font-bold"
                    :class="Number(application.trang_thai) === 2 ? 'bg-emerald-500/10 text-emerald-300' : Number(application.trang_thai) === 3 ? 'bg-rose-500/10 text-rose-300' : Number(application.trang_thai) === 1 ? 'bg-sky-500/10 text-sky-300' : 'bg-amber-500/10 text-amber-300'"
                  >
                    {{
                      Number(application.trang_thai) === 2
                        ? 'Đã nhận'
                        : Number(application.trang_thai) === 3
                          ? 'Từ chối'
                          : Number(application.trang_thai) === 1
                            ? 'Đã xem'
                            : 'Đang chờ'
                    }}
                  </span>
            ...
            <div class="mt-5 space-y-4">
              ...
              <div class="grid grid-cols-2 gap-3">
                <div class="rounded-2xl bg-emerald-500/10 px-4 py-4">
                  <p class="text-xs font-bold uppercase tracking-[0.22em] text-emerald-300">Đã nhận</p>
