...
<template>
  <div class="max-w-6xl mx-auto">
    ...
    <div class="mb-6 rounded-xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
      <div class="grid grid-cols-1 gap-3 border-b border-slate-200 p-4 dark:border-slate-800 xl:grid-cols-[minmax(0,1.4fr)_220px_120px_120px_150px_170px]">
        <input
        ...
        <div class="flex gap-2">
          <button
            class="flex-1 rounded-lg border border-slate-200 px-4 py-2.5 text-sm font-bold text-slate-600 transition hover:bg-slate-50 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800"
            type="button"
            @click="resetFilters"
          >
            Reset bộ lọc
