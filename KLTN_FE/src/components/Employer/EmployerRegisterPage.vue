  ...
  <div class="flex-1 flex items-center justify-center p-4 md:p-10">
    ...
    <div class="w-full max-w-[450px] bg-white dark:bg-slate-900 rounded-xl shadow-xl p-8 md:p-12">
      ...
      <form class="space-y-4" @submit.prevent="handleRegister">
        <!-- Company Name -->
        <div>
          <label class="block text-sm font-semibold mb-1">Tên công ty <span class="text-red-500">*</span></label>
          <input 
        ...
        <!-- Contact Person -->
        <div>
          <label class="block text-sm font-semibold mb-1">Người liên hệ <span class="text-red-500">*</span></label>
          <input 
        ...
        <!-- Company Email -->
        <div>
          <label class="block text-sm font-semibold mb-1">Email công ty <span class="text-red-500">*</span></label>
          <input 
        ...
        <!-- Phone -->
        <div>
          <label class="block text-sm font-semibold mb-1">Số điện thoại <span class="text-red-500">*</span></label>
          <input 
