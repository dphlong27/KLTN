    ...
    public function run(): void
    {
        ...
        $ungTuyenCoDinh = [
            [
                ...
                'thoi_gian_ung_tuyen' => now()->subDays(6)->setHour(9)->setMinute(15),
            ],
            [
                'email' => 'ung.vien5@kltn.com',
                'ho_so' => 'QA Engineer Manual/Automation',
                'tin' => 'QA Engineer (Manual/API)',
                'trang_thai' => UngTuyen::TRANG_THAI_CHAP_NHAN,
                ...
                'thoi_gian_ung_tuyen' => now()->subDays(4)->setHour(14)->setMinute(5),
                'ngay_hen_phong_van' => now()->addDays(3)->setHour(9)->setMinute(0),
                'trang_thai_tham_gia_phong_van' => UngTuyen::PHONG_VAN_DA_XAC_NHAN,
                'thoi_gian_phan_hoi_phong_van' => now()->subDays(1)->setHour(10)->setMinute(30),
            ...
            [
                ...
                'thoi_gian_ung_tuyen' => now()->subDays(5)->setHour(8)->setMinute(40),
            ],
            [
                ...
                'thoi_gian_ung_tuyen' => now()->subDays(7)->setHour(19)->setMinute(10),
            ...
            [
                ...
                'thoi_gian_ung_tuyen' => now()->subDays(3)->setHour(10)->setMinute(20),
                'ngay_hen_phong_van' => now()->addDays(2)->setHour(14)->setMinute(0),
        ...
        foreach ($hoSoCongKhai as $hoSo) {
            $ungVienEmail = $hoSo->nguoiDung?->email;
            $daCoUngTuyen = UngTuyen::where('ho_so_id', $hoSo->id)->exists();

            if ($daCoUngTuyen || !$ungVienEmail || $tinHoatDong->isEmpty()) {
                continue;
            }
            ...
            UngTuyen::create([
                ...
                'ket_qua_phong_van' => $trangThai === UngTuyen::TRANG_THAI_TU_CHOI
                    ? 'Hồ sơ phù hợp ở mức cơ bản nhưng công ty ưu tiên ứng viên có kinh nghiệm sát hơn với vị trí.'
                    : null,
                'ghi_chu' => $trangThai === UngTuyen::TRANG_THAI_TU_CHOI
                    ? 'Lưu hồ sơ cho đợt tuyển dụng tiếp theo.'
                    : null,
                'thoi_gian_ung_tuyen' => now()->subDays(rand(1, 9))->setHour(rand(8, 20))->setMinute(rand(0, 59)),
            ]);

            $tong++;
        }

        $this->command->info("✅ UngTuyenSeeder: Đã tạo {$tong} lượt ứng tuyển với trạng thái gần quy trình thực tế.");
    }
}
